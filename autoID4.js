...
function infoAutoID4(){
    ...
    localStorage.setItem(guardoAutos4,JSON.stringify(datosAuto))
...
function recibir_info_auto4(){

    let recibo = localStorage.getItem(guardoAutos4);
    if (recibo){
