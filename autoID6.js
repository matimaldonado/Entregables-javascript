...
function infoAutoID6(){
    ...
    localStorage.setItem(guardoAutos6,JSON.stringify(datosAuto))
...
function recibir_info_auto6(){

    let recibo = localStorage.getItem(guardoAutos6);
    if (recibo){
